...
export default function EliminarPacienteBoton({ pacienteId, nombrePaciente }: { pacienteId: string; nombrePaciente: string }) {
  ...
  return (
    <button
      ...
      disabled={isDeleting}
      className="flex items-center justify-center gap-2 bg-red-50 text-red-600 px-5 py-2.5 rounded-full text-sm font-bold shadow-sm border border-red-200 hover:bg-red-100 transition-all disabled:opacity-70"
    >

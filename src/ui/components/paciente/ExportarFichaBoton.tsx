  ...
  return (
    <>
      <button
        ...
        className="w-full px-4 py-2.5 bg-gray-100 text-gray-800 font-bold rounded-xl border border-gray-200 shadow-sm text-sm hover:bg-gray-200 transition-all flex items-center justify-center gap-2 disabled:opacity-50"
